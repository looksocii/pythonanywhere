...
def issue(from_privkey, to_address, to_satoshis, metadata, change_address=None,
    ...
    outputs = [{'value': 0, 'addresses': None, 'script_type': 'null-data', 'script': '6a20' + metadata}]
    ...
    if 'errors' in broadcasted_tx:
        ...
        return
    print('tx_id: ', broadcasted_tx['tx']['hash'])
